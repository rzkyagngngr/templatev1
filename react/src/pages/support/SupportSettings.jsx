...
export default function SupportSettings() {
  const settings = [
    { id: 1, name: 'Email Notifications', description: 'Receive email updates for new tickets', enabled: true, icon: Bell },
    { id: 2, name: 'Auto-reply', description: 'Send automatic responses to incoming tickets', enabled: true, icon: Settings },
    { id: 3, name: 'Two-Factor Authentication', description: 'Enhance security with 2FA', enabled: false, icon: Shield },
    { id: 4, name: 'Advanced Filters', description: 'Enable advanced ticket filtering options', enabled: true, icon: Sliders },
  ];
