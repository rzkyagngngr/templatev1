...
export default function Leads() {
    ...
    const [leads] = useState([
        { id: 1, name: 'Donald Gardner', email: 'xyx@gmail.com', phone: '+123456789', company: 'Starbucks coffee', status: 'New Lead', statusColor: 'bg-indigo-500/20 text-indigo-300', img: 'https://mannatthemes.com/metrica/default/assets/images/users/user-10.jpg', isNew: true },
        { id: 2, name: 'Matt Rosales', email: 'xyx@gmail.com', phone: '+123456789', company: 'Mac Donald', status: 'Follow Up', statusColor: 'bg-blue-500/20 text-blue-300', img: 'https://mannatthemes.com/metrica/default/assets/images/users/user-9.jpg' },
        { id: 3, name: 'Michael Hill', email: 'xyx@gmail.com', phone: '+123456789', company: 'Life Good', status: 'Converted', statusColor: 'bg-green-500/20 text-green-300', img: 'https://mannatthemes.com/metrica/default/assets/images/users/user-8.jpg', isNew: true },
        { id: 4, name: 'Nancy Flanary', email: 'xyx@gmail.com', phone: '+123456789', company: 'Flipcart', status: 'New Lead', statusColor: 'bg-indigo-500/20 text-indigo-300', img: 'https://mannatthemes.com/metrica/default/assets/images/users/user-7.jpg' },
        { id: 5, name: 'Dorothy Key', email: 'xyx@gmail.com', phone: '+123456789', company: 'Adidas', status: 'Lost', statusColor: 'bg-red-500/20 text-red-300', img: 'https://mannatthemes.com/metrica/default/assets/images/users/user-6.jpg' },
        { id: 6, name: 'Joseph Cross', email: 'xyx@gmail.com', phone: '+123456789', company: 'Reebok', status: 'New Lead', statusColor: 'bg-indigo-500/20 text-indigo-300', img: 'https://mannatthemes.com/metrica/default/assets/images/users/user-5.jpg' },
    ]);
    ...
    return (
        <div className="w-full">
            ...
            <div className="flex justify-between items-center mb-6">
                <h4 className="text-xl font-bold text-white tracking-wide">Leads</h4>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-6">
                ...
                <div className="lg:col-span-4 glass-card flex items-center gap-4">
                    <img src="https://mannatthemes.com/metrica/default/assets/images/users/user-4.jpg" alt="user" className="w-16 h-16 rounded-full border-2 border-white/20 shadow-lg" />
                    <div className="flex-1">
                        <h5 className="text-lg font-bold text-white m-0">Merri Diamond</h5>
                    ...
                    <div className="flex gap-2">
                        ...
                        <button className="p-2 rounded-full bg-white/5 hover:bg-red-500/20 text-slate-300 hover:text-red-400 transition-colors">
                ...
                <div className="lg:col-span-8 grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="glass-card flex items-center p-4">
                        ...
                        <div className="text-right flex-1">
                            ...
                            <h4 className="text-2xl font-bold text-white">1935</h4>
                        </div>
                    </div>
                    <div className="glass-card flex items-center p-4">
                        <div className="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center mr-4">
                        ...
                        <div className="text-right flex-1">
                            <p className="text-slate-400 text-xs uppercase font-semibold mb-1">Open</p>
                            <h4 className="text-2xl font-bold text-white inline-block mr-2">1240</h4>
                    ...
                    <div className="glass-card flex items-center p-4">
                        ...
                        <div className="text-right flex-1">
                            <p className="text-slate-400 text-xs uppercase font-semibold mb-1">Close</p>
            ...
            <div className="glass-card">
                <div className="flex justify-between items-center mb-4 border-b border-white/5 pb-4">
                    <h4 className="text-lg font-semibold text-white">All Leads</h4>
                    <div className="flex gap-2">
                        <button
                                ...
                                <tr key={lead.id} className="hover:bg-white/5 transition-colors group">
                                    <td className="p-3 border-b border-white/5">
                                        <div className="flex items-center">
                                            ...
                                            <span className="text-sm font-medium text-slate-200 group-hover:text-white transition-colors">{lead.name}</span>
                                            {lead.isNew && <span className="ml-2 text-[10px] px-1.5 py-0.5 rounded bg-pink-500/20 text-pink-300">New</span>}
                                        </div>
                                    </td>
                                    <td className="p-3 text-sm text-slate-400 border-b border-white/5">{lead.email}</td>
                                    <td className="p-3 text-sm text-slate-400 border-b border-white/5">{lead.phone}</td>
                                    <td className="p-3 text-sm text-slate-400 border-b border-white/5">{lead.company}</td>
                                    <td className="p-3 border-b border-white/5">
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
                    <div className="w-full max-w-lg glass-card  animate-in fade-in zoom-in duration-300">
                        <div className="flex justify-between items-center mb-6 pb-4 border-b border-white/10">
                            <h5 className="text-lg font-bold text-white">Add New Lead</h5>
                        ...
                        <form className="space-y-4">
                            ...
                            <div className="flex justify-end gap-3 mt-6 pt-4 border-t border-white/10">
                                ...
                                <button type="button" className="px-4 py-2 rounded-xl bg-primary text-white shadow-[0_0_15px_rgba(14,165,233,0.4)] hover:shadow-[0_0_20px_rgba(14,165,233,0.6)] hover:-translate-y-0.5 transition-all text-sm font-medium">Save Lead</button>
                            </div>
                        </form>
                    </div>
                </div>
