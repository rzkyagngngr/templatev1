        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center">
            ...
            <div className="relative glass-card bg-[#1e1e2e] w-full max-w-md p-6 m-4 animate-in fade-in zoom-in duration-200">
                <div className="flex justify-between items-center mb-4">
                    ...
                    <button onClick={onClose} className="text-tertiary hover:text-white"><span className="material-icons-round">close</span></button>
                </div>
                ...
                <div className="flex justify-end gap-3">
                    ...
                    <button onClick={onClose} className="px-4 py-2 rounded-lg bg-primary text-white hover:bg-primary-dark transition">Confirm</button>
                </div>
            </div>
        </div>
    );
            ...
            <div className="glass-card p-6">
                ...
                <div className="flex flex-wrap gap-4">
                    <button
                        ...
                        className="px-6 py-3 bg-primary text-white rounded-xl shadow-lg shadow-primary/30 hover:scale-105 transition"
                    >
                    ...
                    <button
                        ...
                        className="px-6 py-3 bg-emerald-500 text-white rounded-xl shadow-lg shadow-emerald-500/30 hover:scale-105 transition"
                    >
                        Success Modal
                    </button>
                    ...
                    <button
                        ...
                        className="px-6 py-3 bg-rose-500 text-white rounded-xl shadow-lg shadow-rose-500/30 hover:scale-105 transition"
                    >
                        Danger Modal
                    </button>
                </div>
