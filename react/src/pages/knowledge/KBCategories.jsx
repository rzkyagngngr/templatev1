...
export default function KBCategories() {
  const categories = [
    { id: 1, name: 'Getting Started', articles: '12', subcats: '4' },
    { id: 2, name: 'API Documentation', articles: '28', subcats: '8' },
    { id: 3, name: 'Troubleshooting', articles: '18', subcats: '5' },
    { id: 4, name: 'Best Practices', articles: '15', subcats: '3' },
    { id: 5, name: 'Advanced Topics', articles: '22', subcats: '6' },
    { id: 6, name: 'FAQ', articles: '10', subcats: '2' },
  ];
          ...
          {categories.map((category) => (
            <div key={category.id} className="backdrop-blur-md bg-white/70 border border-gray-300 rounded-lg p-6">
              ...
              <div className="flex gap-6">
                ...
                <div>
                  <p className="text-sm text-black">Subcategories</p>
                  <p className="text-xl font-bold text-black">{category.subcats}</p>
                </div>
              </div>
            </div>
          ))}
