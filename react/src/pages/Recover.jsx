    ...
    return (
        <div className="w-full max-w-md glass-card p-8 animate-in fade-in zoom-in duration-300">
            <div className="text-center mb-8">
                <div className="mx-auto w-12 h-12 rounded-xl bg-gradient-to-br from-amber-500 to-orange-500 flex items-center justify-center text-slate-900 mb-4 shadow-lg shadow-orange-500/30">
            ...
            <form className="space-y-4">
                ...
                <div className="p-3 bg-blue-500/10 border border-blue-500/20 rounded-lg text-xs text-blue-600 flex items-start gap-2">
                    <span className="material-icons-round text-sm">info</span>
                    <span>Remembered your password? <a href="#" className="underline font-bold">Log In</a></span>
                </div>

                <button type="button" className="w-full py-3 bg-amber-500 text-slate-900 font-bold rounded-xl shadow-lg shadow-amber-500/30 hover:scale-105 transition transform active:scale-95">Reset</button>
            </form>
