    ...
    return (
        <div className="w-full">
            ...
            <div className="flex justify-between items-center mb-6">
                <h4 className="text-xl font-bold text-slate-900 tracking-wide">Tasks</h4>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
                ...
                <div className="glass-card p-6">
                    <h4 className="text-lg font-bold text-slate-900 mb-4">Task Status</h4>
                ...
                <div className="glass-card p-6 flex flex-col items-center justify-center text-center">
                    <div className="flex items-center mb-4">
                        <img src="https://mannatthemes.com/Glacia/default/assets/images/users/user-4.jpg" alt="" className="w-20 h-20 rounded-full border-4 border-white/10" />
                        <div className="ml-4 text-left">
                            <h5 className="text-xl font-bold =">Robert Marshall</h5>
                            <p className="text-slate-700 text-sm">Project Manager</p>
                            <div className="flex text-yellow-600 text-sm mt-1">
                    ...
                    <p className="text-slate-700 text-sm mb-6">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin.</p>
                    <div className="flex gap-4 text-sm font-medium text-yellow-600 mb-6">
                        ...
                        <div key={i} className="flex items-center mb-5 last:mb-0">
                            ...
                            <div className="flex-grow">
                                <div className="flex justify-between items-center mb-1">
                                    <h6 className="text-slate-900 font-medium">{item.label}</h6>
                                    <span className="text-slate-700 text-xs">{item.progress}% Complete</span>
                                </div>
            ...
            <div className="flex justify-between items-center mb-6">
                <div className="flex items-center">
                    <h5 className="text-slate-600 mr-2">ðŸ† Glacia's available team members.</h5>
                    <div className="flex -space-x-2">
                        ...
                        <div className="w-8 h-8 rounded-full bg-slate-700 border-2 border-slate-800 flex items-center justify-center text-xs text-slate-900 cursor-pointer">+6</div>
                    </div>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {tasks.map((task) => (
                    <div key={task.id} className="glass-card p-6 hover:bg-white/10 transition-colors">
                        ...
                        <h5 className="text-lg font-bold text-slate-900 mb-2">{task.title}</h5>
                        <p className="text-slate-700 text-sm mb-4">{task.desc}</p>
                        ...
                        <div className="flex justify-between items-center border-t border-white/5 pt-4">
                            <div className="flex -space-x-2">
                                {task.assigned.map((u, i) => (
                                    <img key={i} src={`https://mannatthemes.com/Glacia/default/assets/images/users/user-${u}.jpg`} className="w-8 h-8 rounded-full border-2 border-slate-800" alt="" />
                                ))}
                            </div>
                            <div className="flex gap-4 text-slate-700 text-sm">
                                <span className="flex items-center hover:text-slate-900 cursor-pointer"><span className="material-icons-round text-success text-base mr-1">format_list_bulleted</span> {task.stats.list}</span>
                                <span className="flex items-center hover:text-slate-900 cursor-pointer"><span className="material-icons-round text-primary text-base mr-1">chat_bubble_outline</span> {task.stats.comments}</span>
                                <span className="flex items-center hover:text-slate-900 cursor-pointer"><span className="material-icons-round text-base">edit</span></span>
                                <span className="flex items-center hover:text-red-600 cursor-pointer"><span className="material-icons-round text-base">delete</span></span>
                            </div>
                        </div>
                    </div>
                ))}
